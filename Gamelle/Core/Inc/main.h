...
/* Private defines -----------------------------------------------------------*/
#define GPIO_EN_REG_7V2_Pin GPIO_PIN_15
#define GPIO_EN_REG_7V2_GPIO_Port GPIOC
#define BT_PAIRRING_Pin GPIO_PIN_4
#define BT_PAIRRING_GPIO_Port GPIOF
